      ...
      <main className="flex flex-col px-[50px] ">
        ...
        <section className="flex flex-col gap-[20px] px-[50px] pt-[60px] mb-[100px]">
          <div className="flex gap-[60px]">
            ...
            <p className="text-[25px] font-normal">auralux@space-27.com</p>
          </div>
          <div className="flex gap-[60px]">
            <span className="w-[120px] text-[25px] font-semibold">PHONE</span>
            <p className="text-[25px] font-normal">1800-8893</p>
          </div>
          <div className="flex gap-[60px]">
            <span className="w-[120px] text-[25px] font-semibold">ADDRESS</span>
            <p className="text-[25px] font-normal">서울시 중구 세종대로136, 파이낸스빌딩 8층</p>
          </div>
        </section>
        <section className="flex mb-[150px] w-full h-auto">
          <Image src="/images/img_contact.png" alt="line" width={1820} height={648} objectFit="contain" />
        </section>
      </main>
