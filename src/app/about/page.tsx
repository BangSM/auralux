  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col items-center w-full">
        <section className="relative flex flex-col items-center gap-[100px] w-[100%] overflow-x-auto about-bg">
          <Image
          ...
          <ul className="flex gap-[16px] absolute top-[160px] px-[50px] ">
            <li className="flex flex-col justify-between bg-[#4f2e0f] h-[392px] px-[35px] py-[38px] rounded-[21px] w-[25%]">
              <div className="text-[24px] avenir-black text-[#fff]">HIGH QUALITY</div>
              <div className="flex flex-col gap-[25px]">
                <strong className="text-[24px] avenir-black text-[#fff]">최고의 품질</strong>
                <p className="text-[22px] font-medium text-[#fff] tracking-1 leading-[30px] whitespace-pre-line wrap-break-word">
                  {`오라럭스는 제품 하나하나에 엄격한 품질 기준을 적용하여, 오랜 시간 사용해도 변함없는 내구성과 신뢰를 제공합니다.`}
                </p>
              </div>
            </li>
            <li className="flex flex-col justify-between bg-[#fff] opacity-[0.52] h-[392px] px-[35px] py-[38px] rounded-[21px]  w-[25%]">
