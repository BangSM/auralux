...
const Warranty = () => {
  return (
    <div className="flex flex-col items-center bg-[#efeeee] w-content pb-[247px] pt-[142px]">
      ...
      <div className="flex flex-col gap-[16px]">
        <div className="flex gap-[16px]">
          <div className="relative flex justify-center items-center text-center w-[537px] h-[363px] text-[34px] font-light rounded-[20px] bg-[#ffffff] whitespace-pre">
            {`모든 제품\n평생 제한 무상 보증`}
            <span className="absolute top-[36px] left-[38px] text-[#abaaaa] text-[24px] font-medium">WARRANTY. 1</span>
          </div>
          <div className="relative flex justify-center items-center text-center w-[537px] h-[363px] text-[34px] font-light rounded-[20px] bg-[#ffffff] whitespace-pre ">
            {`전동 블라인드 모터\n5년 무상 보증`}
            <span className="absolute top-[36px] left-[38px] text-[#abaaaa] text-[24px] font-medium">WARRANTY. 2</span>
          </div>
        </div>
